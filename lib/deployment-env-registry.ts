...
export const DEPLOYMENT_ENV_GROUPS: EnvGroupDefinition[] = [
  ...
  },
  {
    id: "email",
    title: "Email (Resend)",
    description: "School workspace verification and receipt email.",
    docsPath: "docs/ORGANIZATION_REGISTRATION.md",
    vars: [
      {
        name: "RESEND_API_KEY",
        label: "Resend API key",
        description: "Required in production for workspace verification email.",
        sensitive: true,
        requirement: "production",
      },
      {
        name: "RESEND_FROM",
        label: "From address",
        description: "Sender identity e.g. ODEL HUB <noreply@domain.com>.",
        sensitive: false,
        requirement: "production",
      },
    ],
