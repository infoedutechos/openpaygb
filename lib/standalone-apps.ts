...
export const STANDALONE_APPS: readonly StandaloneAppDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Self-serve app registry, Partner API keys, Dex payment intents, OPGB balance reads, OAuth client credentials, and webhook endpoints.",
    ...
    allowedPathPrefixes: ["/developers", "/help", "/docs", "/tma"],
    hideEcosystemLinks: true,
  },
];
