...
import { calculateEnergyLimit, calculateEnergyLimitUpgradeCost, calculateMinedPoints } from '@/utils/game-mechanics';
        ...
        try {
            const result = await prisma.$transaction<UpgradeResult | null>(async (prisma) => {
                ...
                await prisma.treasuryTransaction.create({
                    data: { amount: upgradeCost, type: 'energy_limit', userId: dbUser.id },
                });
