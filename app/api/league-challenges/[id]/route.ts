...
export async function GET(
  ...
  return NextResponse.json({
    ...
    return apiErrorResponse(e, { route: "league-challenges/[id]/get", fallback: "Request failed" });
  }
}
...
async function resolveChallenge(prisma: typeof import('@/utils/prisma').default, challengeId: string): Promise<void> {
  ...
  // Refund stake to the winning league's stake-payer(s) first (they put up the PEARLS to start the challenge)
