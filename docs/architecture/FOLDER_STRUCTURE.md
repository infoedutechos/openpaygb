...
**Regenerate snapshot:** `npm run docs:tree:write` (writes `docs/architecture/FOLDER_TREE_SNAPSHOT.txt`).
...
| `npm run docs:tree:write` | Write pruned tree to `docs/architecture/FOLDER_TREE_SNAPSHOT.txt` |
...
**Prisma CLI in full (generate, `db push`, validate, seed, CI):** [PRISMA_COMMANDS.md](../deployment/PRISMA_COMMANDS.md).
...
- [ORGANIZATION_REGISTRATION.md](../school/ORGANIZATION_REGISTRATION.md) — how schools register (pending → approve) and get an org admin / `/admin` dashboard
- [PRISMA_COMMANDS.md](../deployment/PRISMA_COMMANDS.md) — every Prisma CLI usage and npm wrapper in this repo
- [FLOWS.md](../flows/FLOWS.md) — index of **user**, **multi-tenant**, **admin**, and **master** flow write-ups
- [openapi.yaml](../api-reference/openapi.yaml) — HTTP API sketch
- [USER_STORIES.md](../product/USER_STORIES.md) — product stories
