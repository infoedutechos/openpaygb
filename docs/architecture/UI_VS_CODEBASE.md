...
| File | Contents |
|------|-----------|
| [API_INVENTORY.csv](../api-reference/API_INVENTORY.csv) | Every `app/api/**/route.ts` URL, file path, exported HTTP methods |
| [UI_ROUTES.csv](../api-reference/UI_ROUTES.csv) | Every `app/**/page.tsx` UI path and file path |
...
- `/api/master/dex-p2p-disputes` — `app/api/master/dex-p2p-disputes/route.ts`
...
- `/api/master/opgb-withdraws` — `app/api/master/opgb-withdraws/route.ts`
...
| `docs/upstream-ura-game/README.md` claims | This repo |
|----------------------------|-----------|
