...
- [LIVEPAY_INTEGRATION_ASSESSMENT.md](./LIVEPAY_INTEGRATION_ASSESSMENT.md) — MoMo collect (implemented)
- [ECONOMICS.md](./ECONOMICS.md) — UGX / TON settlement
- [SIS_INTEGRATION_COOKBOOK.md](./SIS_INTEGRATION_COOKBOOK.md) — checkout integration
- [SECURITY_HARDENING.md](./SECURITY_HARDENING.md) — webhooks, PCI-minded patterns
- [BACKLOG.md](./BACKLOG.md) — track card program once product owner picks A/B/C
