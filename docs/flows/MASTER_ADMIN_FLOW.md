...
**Login (seed):** `/admin/login?master=1` · `master@odelhub.local` / `ChangeMe_Master123!`  
**OPGB multi-tab console:** `/admin/master/opgb-ops`  
**Credentials pack:** [PLATFORM_UPDATE_2026-09.md](../platform/PLATFORM_UPDATE_2026-09.md) · [LOCAL_DEV_AND_CREDENTIALS.md](../platform/LOCAL_DEV_AND_CREDENTIALS.md)
