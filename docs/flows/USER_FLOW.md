...
For local URLs and seed credentials see **[LOCAL_DEV_AND_CREDENTIALS.md](../platform/LOCAL_DEV_AND_CREDENTIALS.md)**.
...
See [MBIYO_WEBHOOK_SETUP.md](../deployment/MBIYO_WEBHOOK_SETUP.md), [LIVEPAY_INTEGRATION_ASSESSMENT.md](../deployment/LIVEPAY_INTEGRATION_ASSESSMENT.md).
...
Checkout from card balance uses **`POST /api/public/checkout/openpay-card-pay`** (same rail as PayWizard “OpenPayGB card”). See [OPGB_CHECKOUT_CARD.md](../platform/OPGB_CHECKOUT_CARD.md).
