...
> **Sep 2026 operational pack (commands + all logins + OPGB/Uwais):** [PLATFORM_UPDATE_2026-09.md](../platform/PLATFORM_UPDATE_2026-09.md) · [LOCAL_DEV_AND_CREDENTIALS.md](../platform/LOCAL_DEV_AND_CREDENTIALS.md) · [OPENPAYGB_PAYMENT_PROVIDER.md](../platform/OPENPAYGB_PAYMENT_PROVIDER.md)
...
| Partner / merchant developer | Accept payments via OpenPayGB hosted checkout; cash out settlement | `/developers`, `/opgb`, Partner API | Developer session + `odelhub_live_…` API key |
...
- Dex Hub + OPGB ledger: `app/dex/**`, `lib/opgb-ledger.ts`, `app/api/public/dex/**`, `app/api/student/dex/**` (custodial Phase 1–3; see `docs/platform/OPGB_TOKEN_ECOSYSTEM.md`).
...
Partner docs baseline: `docs/platform/PARTNER_API.md`.
...
- Deployment target documented for Vercel (`docs/upstream-ura-pearl/VERCEL_ENV_SETUP.md`, `docs/architecture/DEPLOYMENT_ARCHITECTURE.md`).
...
- `.env.example`
- `docs/upstream-ura-pearl/VERCEL_ENV_SETUP.md`
...
- `docs/api-reference/UI_ROUTES.csv` (generated list)
- `docs/architecture/UI_VS_CODEBASE.md`

## API inventory summary

From `docs/api-reference/API_INVENTORY.csv`:
...
- `docs/platform/PARTNER_API.md`
- `docs/flows/MULTI_TENANT_FLOW.md`
- `docs/flows/MASTER_ADMIN_FLOW.md`
- `docs/flows/ADMIN_FLOW.md`
- `docs/school/ORGANIZATION_REGISTRATION.md`
- `docs/operations/BACKUP_AND_RECOVERY.md`
- `docs/upstream-ura-pearl/VERCEL_ENV_SETUP.md`
- `docs/architecture/DEPLOYMENT_ARCHITECTURE.md`
- `docs/architecture/UI_VS_CODEBASE.md` (regenerate: `npm run docs:inventory` — **97 UI routes**, **369 API handlers** as of 2026-07-16)
- `docs/api-reference/API_INVENTORY.csv`
- `docs/api-reference/UI_ROUTES.csv`
- `docs/product/HOLISTIC_APP_AUDIT.md`, `docs/product/APP_STATUS_AUDIT.md`
- `docs/platform/OPGB_TOKEN_ECOSYSTEM.md`, `docs/platform/OPGB_CHECKOUT_CARD.md`
