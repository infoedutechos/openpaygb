...
- **APIs / UI:** See `docs/api-reference/API_INVENTORY.csv` and `docs/api-reference/UI_ROUTES.csv` (regenerate: `npm run docs:inventory`)
...
**Docs:** [SCHOOL_ADMIN_LOGIN.md](../school/SCHOOL_ADMIN_LOGIN.md), [ORGANIZATION_REGISTRATION.md](../school/ORGANIZATION_REGISTRATION.md), [LOCAL_DEV_AND_CREDENTIALS.md](../platform/LOCAL_DEV_AND_CREDENTIALS.md)
...
| Checklist | [PRODUCTION_GO_LIVE.md](../deployment/PRODUCTION_GO_LIVE.md), [VERCEL_ODELPAY_DEPLOY.md](../deployment/VERCEL_ODELPAY_DEPLOY.md) |
...
- Telegram / TMA: [TELEGRAM_MINI_APP.md](../deployment/TELEGRAM_MINI_APP.md) + scan §8
