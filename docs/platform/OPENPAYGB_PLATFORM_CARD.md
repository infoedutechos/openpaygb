...
**Related:** [VIRTUAL_CARD_INVESTIGATION.md](./VIRTUAL_CARD_INVESTIGATION.md) (closed-loop MVP shipped) · [TELEGRAM_MINI_APP.md](../deployment/TELEGRAM_MINI_APP.md) (TMA Card tab)
...
| MoMo / dev guide | [VIXONPAY_VIRTUAL_CARD_AND_DEV.md](../deployment/VIXONPAY_VIRTUAL_CARD_AND_DEV.md) |
