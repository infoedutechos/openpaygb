...
1. Copy `integrations/woocommerce/odelhub-openpaygb/` into `wp-content/plugins/odelhub-openpaygb/`.
2. Activate **OpenPayGB for WooCommerce** in WP Admin → Plugins.
3. WooCommerce → Settings → Payments → **OpenPayGB**:
...
4. Register webhook URL on the Developer dashboard:
...
- Plugin path: `integrations/woocommerce/odelhub-openpaygb/`
