...
**New location:** [`deployment/TELEGRAM_BOT_DEPLOYMENT.md`](./deployment/TELEGRAM_BOT_DEPLOYMENT.md)
...
---
*Stub kept so older links to `docs/TELEGRAM_BOT_DEPLOYMENT.md` still resolve.*
