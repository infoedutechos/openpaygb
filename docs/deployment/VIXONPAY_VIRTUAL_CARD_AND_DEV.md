...
Requires `npm run db:push` and `npm run seed`. More: [LOCAL_DEV_AND_CREDENTIALS.md](../platform/LOCAL_DEV_AND_CREDENTIALS.md).
...
See also [PRODUCTION_GO_LIVE.md](./PRODUCTION_GO_LIVE.md) and [VERCEL_ENV_SETUP.md](../upstream-ura-pearl/VERCEL_ENV_SETUP.md).

---

## 11. Related docs

- [LOCAL_DEV_AND_CREDENTIALS.md](../platform/LOCAL_DEV_AND_CREDENTIALS.md) — seeds, dev reset, LivePay/Relworx notes  
- [MBIYO_WEBHOOK_SETUP.md](./MBIYO_WEBHOOK_SETUP.md) — parallel pattern for another MoMo rail  
- [VIRTUAL_CARD_INVESTIGATION.md](../platform/VIRTUAL_CARD_INVESTIGATION.md) — external Visa/MC issuing options (not OpenPayGB closed-loop card)
