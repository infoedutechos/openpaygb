...
5. **Framework:** Next.js.
6. Add environment variables — see [VERCEL_ENV_SETUP.md](../upstream-ura-pearl/VERCEL_ENV_SETUP.md).
...
| Build fails | Open failed deployment → **Build Logs**; fix env vars ([VERCEL_ENV_SETUP.md](../upstream-ura-pearl/VERCEL_ENV_SETUP.md)) |
...
- [VERCEL_ENV_SETUP.md](../upstream-ura-pearl/VERCEL_ENV_SETUP.md) — environment variables
- [DEPLOYMENT_ARCHITECTURE.md](../architecture/DEPLOYMENT_ARCHITECTURE.md) — MongoDB, cron, serverless
