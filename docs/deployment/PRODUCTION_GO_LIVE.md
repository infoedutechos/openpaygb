...
Optional: `LIVEPAY_WEBHOOK_URL` (if dashboard URL differs from `NEXT_PUBLIC_APP_URL`), `TONAPI_KEY`, `FX_LIVE_ENABLED`, `CHECKOUT_PLATFORM_FEE_UGX`, etc. — see [VERCEL_ENV_SETUP.md](../upstream-ura-pearl/VERCEL_ENV_SETUP.md).

Workspace registration flow: [ORGANIZATION_REGISTRATION.md](../school/ORGANIZATION_REGISTRATION.md) · audit: [APP_STATUS_AUDIT.md](../product/APP_STATUS_AUDIT.md).
