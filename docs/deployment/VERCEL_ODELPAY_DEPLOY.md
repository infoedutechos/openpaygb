...
Full list: [VERCEL_ENV_SETUP.md](../upstream-ura-pearl/VERCEL_ENV_SETUP.md)
...
- [SCHOOL_WORKSPACE_SELF_REGISTER.md](../school/SCHOOL_WORKSPACE_SELF_REGISTER.md) — school self-registration, ODEL HUB Copilot, favicon fetch
