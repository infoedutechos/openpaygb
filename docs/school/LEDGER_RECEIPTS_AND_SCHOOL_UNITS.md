...
Full guide: [WEBHOOK_SECRETS_ALIGNMENT.md](../deployment/WEBHOOK_SECRETS_ALIGNMENT.md)
...
TMA shell: `/tma` · See [TELEGRAM_MINI_APP.md](../deployment/TELEGRAM_MINI_APP.md)
...
- [MULTI_TENANT_FLOW.md](../flows/MULTI_TENANT_FLOW.md)
- [BACKLOG.md](../product/BACKLOG.md) — B-OPS-02, B-UX-05b
