...
See also: **[LOCAL_DEV_AND_CREDENTIALS.md](../platform/LOCAL_DEV_AND_CREDENTIALS.md)** (dev URLs and seed logins), **[APP_STATUS_AUDIT.md](../product/APP_STATUS_AUDIT.md)** (holistic scan), **[FOLDER_STRUCTURE.md](../architecture/FOLDER_STRUCTURE.md)** (admin routes), **[PRISMA_COMMANDS.md](../deployment/PRISMA_COMMANDS.md)** (schema/DB).
